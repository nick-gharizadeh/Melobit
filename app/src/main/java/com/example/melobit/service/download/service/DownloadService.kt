package com.example.melobit.service.download.service
...
import com.example.melobit.service.download.async_download.AsyncDownload
            ...
            if (DownloadManager.indexToDownload < list.size) {
                ...
                if (fileToDownload != null && !fileToDownload.isDownloaded) {
                    ...
                    notificationBuilder = NotificationCompat.Builder(this, NOTIFICATION_CHANNEL)
                        .setSmallIcon(com.example.melobit.R.drawable.ic_app)
